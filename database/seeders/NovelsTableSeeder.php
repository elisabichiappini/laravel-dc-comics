...
class NovelsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($novels as $novel) {
            //istanzio la classe
            $newNovel = new Novel();
            //popolo i records della classe Novel
            $newNovel->title = $novel['title'];
            $newNovel->description = $novel['description'];
            $newNovel->thumb = $novel['thumb'];
            $newNovel->price = $novel['price'];
